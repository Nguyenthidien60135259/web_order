...
(22, 36, 4, 'ngon quá ạ', NULL, NULL),
(23, 36, 4, 'ngon quá ạ', NULL, NULL);
...
(37, 'chien1234', 'chien@gmail.com', 'MjM0NTY3ODk=', '2022-01-08', 1, 'nha trang khánh hòa 2', '01234274243', 52, NULL, NULL);
...
(116, 34, NULL, 40000, 1, 'viet', 'nha trang', '08716718321', 'không', '2022-01-14', NULL, NULL),
(117, 37, 1, 30000, 1, 'chien1234', 'nha trang khánh hòa', '0338219249', 'ok', '2022-01-14', NULL, NULL),
(118, 37, NULL, 85000, 0, 'chien1234', 'nha trang khánh hòa', '0338219249', 'ok', '2022-01-14', NULL, NULL),
(119, 37, NULL, 85000, 0, 'chien1234', 'nha trang khánh hòa', '0338219249', 'ok', '2022-01-14', NULL, NULL);
...
INSERT INTO `order_details` (`order_id`, `product_id`, `quantity`, `listTopping`, `size_id`) VALUES
(117, 7, 1, 'Thạch, Cream cheese', 1),
(118, 7, 3, 'Thạch, Cream cheese', 2),
(119, 9, 3, 'Trân châu, Đào', 2),
(116, 18, 2, 'Không thêm', 1);
...
(1, 'App\\Models\\User', 53, 'My Token', 'b813b2e95f3d8d7c3b4f1c6fb3cef40241aaeb742d9d28e2358a3f615913c236', '[\"*\"]', NULL, '2022-01-14 07:32:48', '2022-01-14 07:32:48'),
(2, 'App\\Models\\User', 54, 'My Token', 'd771c89511e8727f5ff4188e03720f0e114b5b9087bdf72f5781301db5f3f01e', '[\"*\"]', NULL, '2022-01-14 07:33:22', '2022-01-14 07:33:22');
...
INSERT INTO `tb_table` (`id`, `name`) VALUES
(1, 'Bàn 1'),
(2, 'Bàn 2'),
(3, 'Bàn 3'),
(4, 'Bàn 4'),
...
(52, 'chien1234', 'chien@gmail.com', 'MjM0NTY3ODk=', NULL, 3, '2022-01-14 06:38:34', '2022-01-14 06:53:32'),
(54, 'admin', 'admin@gmail.com', 'MTIzNA==', NULL, 1, '2022-01-14 07:33:22', '2022-01-14 07:33:22');
...
ALTER TABLE `order_details`
  ADD PRIMARY KEY (`product_id`,`order_id`,`size_id`),
...
ALTER TABLE `order_details`
  ...
  ADD CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`size_id`) REFERENCES `size` (`id`),
