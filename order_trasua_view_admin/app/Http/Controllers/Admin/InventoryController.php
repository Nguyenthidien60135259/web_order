...
class InventoryController extends Controller
{
    function chartInventory()
    {
        if(Session::has("email")=="admin@gmail.com"){
            $api_response = Http::get("http://api.trasuanhatrang.cf/api/inventory_list");
    ...
    function filter_by_date(Request $request)
    {
        ...
        $api_response = Http::post("http://api.trasuanhatrang.cf/api/filter_by_date/",$data);
        $data = json_decode($api_response);
    ...
    function subs365days(Request $request)
    {
        ...
        $api_response = Http::post("http://api.trasuanhatrang.cf/api/subs365days/",$data_0);
    ...
    function thisMonth(Request $request)
    {
        ...
        $api_response = Http::post("http://api.trasuanhatrang.cf/api/thisMonth/",$data_2);
