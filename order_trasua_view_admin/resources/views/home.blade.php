...
@section('content')
    ...
    <div class="slider-item"><img src="http://api.trasuanhatrang.cf/introducts/review2.jpg">
    ...
    <div class="one-half img" style="background-image: url(http://api.trasuanhatrang.cf/introducts/story.jpg);"></div>
