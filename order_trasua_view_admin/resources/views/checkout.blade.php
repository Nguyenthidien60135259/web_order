...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(http://api.trasuanhatrang.cf/introducts/store.jpg);" data-stellar-background-ratio="0.5">
                        ...
                        <table id="cart" class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center" data-id="{{ $key }}">
                                    ...
                                    <td class="image-prod">
                                        <img class="img" src="http://api.trasuanhatrang.cf/products/{{$cart['image']}}">
                                    </td>
