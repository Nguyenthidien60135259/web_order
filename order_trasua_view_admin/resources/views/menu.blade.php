...
<section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(http://api.trasuanhatrang.cf/introducts/review2.jpg);" data-stellar-background-ratio="0.5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-5 pb-3">
                ...
                <a href="/detail/{{ $product->id }}">
                    <div class="img" style="background-image: url(http://api.trasuanhatrang.cf/products/{{$product->image}});"></div>
                </a>
                    <div class="desc pl-3">
                        ...
                        <div class="tab-content ftco-animate" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="/detail/{{$new->id}}" class="menu-img img mb-4" style="background-image: url(http://api.trasuanhatrang.cf/products/{{$new->image}});"></a>
                                            <div class="text">
                                                <h3><a href="/detail/{{ $new->id }}">{{$new->name}}</a></h3>
                                                <!-- <p>{{$new->name}}</p> -->
                                                <p class="price"><span>{{ number_format($new->price,0,',','.') }} đ</span></p>
                                                <p><a href="{{ url('add-cart/'.$new->id) }}" class="btn btn-primary">Add to cart</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                            ...
                            <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="/detail/{{ $expensive->id }}" class="menu-img img mb-4" style="background-image: url(http://api.trasuanhatrang.cf/products/{{$expensive->image}});"></a>
                                            <div class="text">
                                                <h3><a href="/detail/{{ $expensive->id }}">{{$expensive->name}}</a></h3>
                                                <!-- <p>{{$expensive->desc}}</p> -->
                                                <p class="price"><span>{{ number_format($expensive->price,0,',','.') }} đ</span></p>
                                                <p><a href="{{ url('add-cart/'.$expensive->id) }}" class="btn btn-primary">Add to cart</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                            ...
                            <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="/detail/{{ $cheap->id }}" class="menu-img img mb-4" style="background-image: url(http://api.trasuanhatrang.cf/products/{{$cheap->image}});"></a>
                                            <div class="text">
                                                <h3><a href="/detail/{{ $cheap->id }}"></a>{{$cheap->name}}</h3>
                                                <!-- <p>{{$cheap->desc}}</p> -->
                                                <p class="price"><span>{{ number_format($cheap->price,0,',','.') }} đ</span></p>
                                                <p><a href="{{ url('add-cart/'.$cheap->id) }}" class="btn btn-primary">Add to cart</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
