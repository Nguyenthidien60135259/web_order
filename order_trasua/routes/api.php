...
Route::get("user_all",[AdminUserController::class,'user']);
Route::get("user_all/{id}",[AdminUserController::class,'show']);
Route::get("user_id/{id}",[AdminUserController::class,'show_id']);
...
Route::post('appOrder',[CartController::class,'appOrder']);
Route::post('appOrderDetail',[CartController::class,'appOrderDetail']);
Route::post('updateComment/{id}',[PagesController::class,'updateComment']);
